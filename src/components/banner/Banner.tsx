...
export const Banner = () => {
    return (
        <div className="w-full h-full flex justify-center px-6 sm:px-12">
            <div
                className="w-full flex flex-col items-center mt-24 max-w-[1180px] h-[520px] sm:h-[540px] tablet:h-[640px] lg:h-[680px] rounded-3xl xl:rounded-br-[300px] bg-gradient-to-r from-green to-lightBlue shadow-banner">
                <div
                    className="w-full flex flex-col flex-1 items-center lg:items-start text-center mt-16 xs:mt-12 tablet:mt-16 lg:mt-20">
                    <div className="w-[90%] lg:w-[50%] lg:ml-12 flex flex-col items-center z-10">
                        <p
                    ...
                    <div
                        className="w-full z-0 flex flex-1 ml-6 justify-center lg:relative lg:left-52 lg:bottom-[125px] xl:left-56 xl:bottom-[155px] items-end ">
                        <img
