...
export const Banner = () => {
    return (
        <div className="w-full h-full flex justify-center px-6 sm:px-12">
            <div
                className="w-full flex flex-col items-center mt-24 max-w-[1180px] h-[520px] sm:h-[540px] tablet:h-[640px] lg:h-[680px] rounded-3xl lgXl:rounded-br-[300px] bg-gradient-to-r from-green to-lightBlue shadow-banner">
                <div
