...
export const Navbar: React.FC = () => {
    ...
    return (
        <>
            <header
                className="w-full bg-light dark:bg-dark fixed h-20 top-0 left-0 right-0 px-4 xs:px-12 flex items-center justify-center shadow-lg z-50">
              ...
              text-lightBlue
                ...
                hover:before:opacity-100"
                        ...
                        <div
                            ...
                            <Switch/>
                            <button
                                className="bg-lightBlue uppercase font-bold text-sm text-[#FFFFFF] dark:text-dark px-6 py-2 rounded-[20px] transition ease-in-out duration-300 shadow-Button hover:shadow-darkButton hover:opacity-60 mr-2">
                                Book Now
                            </button>
                        </div>
                        <div
