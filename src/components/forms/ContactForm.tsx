                    ...
                    <Form className='w-full sm:w-[500px]' onSubmit={handleSubmit}>
                        ...
                        <div className='mb-2'>
                            <Field type="name" name="name" id='name' placeholder='Your Name'
                                   className={ClassNames(errors.name ? 'border-2 border-red-500' : '', 'w-full h-10 bg-[#F1F2F8] rounded-lg p-2 mb-2 text-sm')}/>
                        ...
                        <div className='mb-2'>
                            <Field type="email" name="email" id='email' placeholder='Your Email'
                                   className={ClassNames(errors.email ? 'border-2 border-red-500' : '', 'w-full h-10 bg-[#F1F2F8] rounded-lg p-2 mb-2 text-sm')}/>
                            <ErrorMessage name="email" component="div" className='w-full text-xs text-red-500'/>
                        </div>
                        <div className='mb-2'>
                            <Field component='textarea' rows={4} name="message" id='message' placeholder='Your Message'
