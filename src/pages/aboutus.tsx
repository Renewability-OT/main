                    ...
                    <div
                        ...
                        <div
                            ...
                            <p className="font-light text-[14px] sm:text-[18px] text-black dark:text-white indent-10"><span
                                ...
                                issues, owned by Diane Gubisch, PhD, OTR/L, ADHD-CCSP, ASD-clinical specialist, and Art
                            ...
                            <p className="font-light text-[14px] sm:text-[18px] text-black dark:text-white indent-10 mt-4"><span
                                ...
                                psychological and spiritual goals provided for the pediatric to the geriatric client. A
                            ...
                            <p className="font-light text-[14px] sm:text-[18px] text-black dark:text-white indent-10 mt-4"><span
                                ...
                                harmony to their home. Therapy is provided in a loving and playful manner to capitalize
                                on current abilities while providing opportunities for physical, cognitive and emotional
                            ...
                            <p className="font-light text-[14px] sm:text-[18px] text-black dark:text-white indent-10 mt-4"><span
                                ...
                                they are
                                transitioning
                                into the next phase of their life, whether that is college or entering the work force or
                                moving out of their parents home. Teaching skills to enable these young adults to
                                succeed. The approach to the <span
                                    className='font-semibold'>geriatric</span> client is based on the belief that age is
                                a
                                relative idea and you can be and do all you can at any age. Acknowledging that over time
                                the human mind, body and spirit goes through tremendous challenges and losses but where
