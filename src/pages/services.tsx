    ...
    return (
        <>
            <Layout title="Services">
                <div
                    className="w-full h-full flex flex-col justify-center items-center px-6 pt-6 sm:px-12 mt-20 bg-superLightBlue">
                    ...
                    <div
                        ...
                        <div
                            className="w-full max-w-[400px] h-full px-6 bg-lightBlue/30 rounded-2xl">
                        ...
                        <div
                            className="w-full max-w-[400px] h-full px-6 bg-lightBlue/20 rounded-2xl">
                            <div className='w-full h-full flex flex-col justify-center items-center mt-8'>
                                <div className='w-full h-full flex justify-center items-center'>
                ...
                <div className='w-full h-full bg-superLightBlue'>
                    <div
                        ...
                        <div className='w-full xl:w-container h-full'>
                            <p className="w-full mt-4 flex items-center justify-center h-fit text-center text-black dark:text-white text-[22px] xl:text-[32px] font-bold leading-9 drop-shadow-blog">Reiki</p>
